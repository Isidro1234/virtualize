...
export default function AppearanceMenu() {
  ...
  return (
    <VStack paddingTop={10} gap={10}>
        ...
        <Button className='link-item-btn' background={pathname === '/appearence/calls' ? '#00bf63' : 'transparent'} onClick={()=>{router.push('/appearence/calls')}} borderRadius={50} size={'md'}><Icons.Phone strokeWidth={1} width={50} height={50}/></Button>
