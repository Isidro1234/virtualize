       ...
       <motion.div style={{width:"100%"}} initial={{opacity:0}} animate={{opacity:1, }} transition={{duration:1}}>
             <VStack  gap={0} position={'relative'} alignItems={'flex-start'} backgroundColor={'#1d1d1d'} justifyContent={'center'} width={'100%'} height={"90vh"}>
               <VStack padding={10}   marginTop={4} zIndex={100} position={'absolute'} alignItems={'flex-start'}>
                     ...
                     <Heading className='text-title' fontSize={45} color={'white'} lineHeight={1.2} minWidth={100} maxWidth={520}>About <Span color={'#00bf63'}>us</Span> </Heading>
                     <Text marginTop={4} fontSize={18} minWidth={100}  maxWidth={400} color={"#e6e6e6e6"}>we are a educational startup focused on
           ...
           <HStack className='Debates' justifyContent={'flex-start'} width={'100%'}  padding={10} background={'#1f1f1f'}>
                   <VStack alignItems={'flex-start'} flex={1} padding={10}>
                     <Heading className='text-title' lineHeight={1.1} fontSize={64} color={'white'}>Check out the set of activities  <Span color={'#00bf63'}>on our platforms</Span> </Heading>
                   ...
                   <Image className='images' alt="live" height={500} width={500} src={'/online.png'}/>
